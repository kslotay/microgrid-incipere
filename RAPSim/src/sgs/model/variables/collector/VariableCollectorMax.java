...
public class VariableCollectorMax extends VariableCollector {
	 ...
	 * @param variableName
	 */
	public VariableCollectorMax(EnumPV variableName) {
		super(variableName);
	...
	@Override
	public VariableCollectorMax copy() {
		VariableCollectorMax tmp = new VariableCollectorMax(variableName);
